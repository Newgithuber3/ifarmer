  ...
  <el-container>
    ...
    <el-main>
      <div class="register-main">
        <el-form  class="register-form" label-position="top" label-width="80px"
                  :rules="rules" ref="registerForm" status-icon :model="registerdata">
          ...
          <el-form-item label="确认密码" prop="password2">
            <el-input v-model="registerdata.password2" placeholder="请再次确认密码"></el-input>
          </el-form-item>
          <el-button
            @click = "submitRegister('registerData')"
            class="submit-btn" type="danger">提交</el-button>
        </el-form>
      </div>
    </el-main>
  </el-container>
